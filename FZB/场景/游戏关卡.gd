...
@onready var hand_manager: 植物种植 = $Manager/HandManager
@onready var zombie_manager: 出怪逻辑 = $Manager/ZombieManager
@onready var card_manager: 选卡 = $Camera2D/CardManager
## 控制台
@onready var control_panel: 控制台 = $CanvasLayer/All_UI/MainGameMenuOptionDialog/Option/Button4/控制台

#endregion


#region UI元素、相机
@onready var ui_remind_word: 警告提示 = $UIRemindWord
@onready var camera_2d: 游戏相机2d = $Camera2D
...
func start_game_move_camera():
	# 移动相机查看僵尸
	await camera_2d.move_to(Vector2(300, 0), 2)
